...
## Campaign Map Editor - Visual grid-based editor for campaign map regions
...
func _enter_tree() -> void:
	...
	dock = preload("res://addons/campaign_map_editor/campaign_map_editor_dock.gd").new()
	dock.name = "CampaignMapEditor"

	# Create popup window
	window = Window.new()
	window.title = "Campaign Map Editor"
	...
	toolbar_button.text = "Campaign Map"
	toolbar_button.tooltip_text = "Open Campaign Map Editor for regions and biomes"
	...
	print("[CampaignMapEditor] Plugin enabled - Click 'Campaign Map' button in toolbar")
...
func _exit_tree() -> void:
	...
	print("[CampaignMapEditor] Plugin disabled")
